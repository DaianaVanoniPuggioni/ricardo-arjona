...
En lo que será una noche verdaderamente inolvidable, YSY A va a poner a temblar una vez más a toda la Ciudad de Buenos Aires: “Lo voy a disfrutar un montón, siempre que me subo a cantar a un escenario es el mejor momento de mi vida”. Combinando sus clásicos con las canciones de sus discos más recientes (‘TRAP DE VERDAD’, ‘YSYSMO’ y ‘TU DÚO FAVORITO’) –y las de su nuevo trabajo de estudio que será revelado como siempre el 11/11, YSY A no va a dejar ninguna de sus etapas afuera de la lista y aprovechará la oportunidad para volver a abrirle la puerta a la música del futuro. Un paso gigante para un artista como ya quedan muy pocos dentro de la escena no solo nacional, sino también global. Un paso gigante para alguien que trabajó desde el primer día para dejar bien alto a la cultura popular argentina, siempre llevando al arte genuino como bandera. <br /><br />
